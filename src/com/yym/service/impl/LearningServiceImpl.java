...
public class LearningServiceImpl implements LearningService{
	...
	public int insWords(String tabel_name, String word, String us_pron, String uk_pron, String us_mp3, String uk_mp3,
			...
			String bil_ex3, String collocation, int status, Date dates) {
		// TODO Auto-generated method stub
		int result=learningDao.insWords(tabel_name, word, us_pron, uk_pron, us_mp3, uk_mp3, explanation, val_ex1, bil_ex1, val_ex2, bil_ex2, val_ex3, bil_ex3, collocation, status, dates);
		return 0;
	}
